...
import PaymentButton from "@/components/global/buy-button";
...
function PricingCard(props: PricingTabProps) {
  return (
    <div className={`h-full ${props.popular ? "dark" : ""}`}>
      <div className="relative flex flex-col h-full p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-900 shadow shadow-slate-950/5">
        ...
        <div className="mb-5">
          ...
          <PaymentButton priceId={props.priceId} />
        </div>
...
export default function PricingTable() {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      {/* Pricing toggle */}
      <div className="flex justify-center m-auto mb-8 lg:mb-16 max-w-[14rem]">
