...
const Hero = () => {
  return (
    <section className="relative overflow-hidden py-10 flex items-center justify-center">
      <div className="container">
        ...
        <div className="mx-auto flex max-w-7xl flex-col items-center">
          <div className="z-10 flex flex-col items-center gap-6 text-center">
            ...
            <div>
              <h1 className="mb-6 text-pretty text-2xl font-bold lg:text-7xl">
                Build your next project with TICCO.st
              </h1>
            ...
            <div className="mt-4 flex justify-center gap-2">
              <Button className="rounded-xl  px-8 py-5 font-bold text-lg">
                Get Started
              </Button>
              <Button
                variant="outline"
                className="rounded-xl px-8 py-5 text-lg"
              >
            ...
            <div className="mt-10 flex flex-col items-center gap-4 bg-white w-full">
              <div className="border-8 border-gray-100 p-4 rounded-lg aspect-video">
                <img
                  src="https://www.shadcnblocks.com/images/block/block-1.svg"
                  alt="logo"
                  className="h-16"
                />
                <h2 className="text-lg font-bold mt-2">Community Updates</h2>
                <p className="text-gray-700 mt-2">
                  Join our community to stay updated on new block releases and
                  features.
                </p>
                <Button className="px-8 py-3 font-bold text-lg mt-4 rounded-xl">
                  Join Community
                </Button>
              </div>
            </div>
